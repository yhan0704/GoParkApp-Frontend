  ...
  return (
    <div className="backgroundImg">
      ...
      <div className="cardContainer">
        {removeDuplicadtePark(props.parks)
...
const mapStateToProps = (store) => ({
  parks: store.parks
    .filter((park) =>
      park.fullName.toLowerCase().includes(store.parkName.toLowerCase())
    )
    .filter((park) =>
      park.states.toLowerCase().includes(store.filter.toLowerCase())
    ),
